...
const Experience = ({experience}) => {
    ...
    return (
        <div className="text-green-50 bg-cover object-cover bg-center bg-no-repeat p-6 rounded-lg shadow-2xl" style={{ backgroundImage: "url('src/assets/images/projects/4.jpg')" }}>
