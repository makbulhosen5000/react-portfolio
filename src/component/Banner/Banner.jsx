...
import profileImage from '../../assets/images/ak1.png';
    ...
    return (
        ...
        <div className="bg-gray-900 text-white">
            <div className="relative flex h-80 overflow-hidden">
                ...
                <div className="text-left text-yellow-300 hover:text-white text-xl text-bold">
                    
                    <p className=' '>{'const Welcome = () =>'}</p>
                    <p className=''>{'{'}</p>
                    <p><span className=' '> {'console.log("Hey! I AM MD.MAKBUL HOSEN");'}</span></p>
       ...
       {/* developer profile */}
        <div className=" my-8 rounded-xl max-w-full mx-auto bg-white p-8 shadow-xl flex items-center neumorphic-bg" 
            
        >

            <div className="flex-shrink-0"
             data-aos="fade-up">
                <img src={profileImage} alt="Your Image" className="rounded-md w-48 h-48"  />
            </div>
